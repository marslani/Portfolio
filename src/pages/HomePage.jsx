    ...
    <div className="home-page">
        ...
        <div className="container-shell hero-section__inner">
          ...
          >
            <Card className="profile-card">
              ...
              <div className="profile-card__avatar">MA</div>
      ...
      <section className="about-section" id="about">
        <div className="container-shell about-section__grid">
          <SectionTitle eyebrow="About" title="Built for clarity, scale, and real-world product delivery." />
      ...
      <section className="skills-section" id="skills">
        <div className="container-shell">
          <SectionTitle eyebrow="Skills" title="Tools and systems that support product work from idea to release." align="center" />
                ...
                <div className="skill-card__list">
                  {skills.map((skill) => (
                    <div key={skill.name} className="skill-card__item">
                      ...
                      <div className="skill-card__meter" aria-label={`${skill.name} skill level ${skill.value}%`}>
      ...
      <section className="architecture-section" id="architecture">
        <div className="container-shell">
          <SectionTitle eyebrow="Architecture" title="System patterns shaped for maintainable product delivery." />
      ...
      <section className="projects-section" id="projects">
        <div className="container-shell">
          <div className="projects-section__top">
            <SectionTitle eyebrow="Projects" title="Selected work across product, mobile, and desktop experiences." />

            <div className="projects-section__filters" aria-label="Project filters">
      ...
      <section className="workflow-section" id="workflow">
        <div className="container-shell">
          <SectionTitle eyebrow="Workflow" title="A repeatable system for building what matters without unnecessary overhead." />
      ...
      <section className="experience-section" id="experience">
        <div className="container-shell">
          <SectionTitle eyebrow="Experience" title="Product-focused engineering experience shaped around real delivery work." />
      ...
      <section className="resume-section" id="resume">
        <div className="container-shell resume-section__inner">
          <div>
            <SectionTitle eyebrow="Resume" title="A concise overview of the work and value I bring to product teams." />
      ...
      <section className="faq-section" id="faq">
        <div className="container-shell">
          <SectionTitle eyebrow="FAQ" title="Questions teams often ask before starting a project." align="center" />

          <div className="faq-list">
            {faqData.map((item, index) => (
              <div key={item.question} className={`faq-item ${openFaq === index ? 'faq-item--open' : ''}`}>
                <button type="button" className="faq-item__button" onClick={() => setOpenFaq(openFaq === index ? -1 : index)}>
                  <span>{item.question}</span>
                  <span className="faq-item__toggle">{openFaq === index ? '−' : '+'}</span>
                </button>
                {openFaq === index ? <p className="faq-item__answer">{item.answer}</p> : null}
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="contact-section" id="contact">
        <div className="container-shell contact-section__inner">
          <div className="contact-section__content">
            <SectionTitle eyebrow="Contact" title="Let’s build product experiences that feel clean, fast, and dependable." />
          ...
          <form className="contact-form" onSubmit={handleSubmit} noValidate>
            <div className="contact-form__field">
              ...
              <input id="name" name="name" value={formData.name} onChange={handleChange} aria-invalid={Boolean(errors.name)} />
      ...
      <Link to="/terms" className="home-page__legal-link home-page__legal-link--secondary">Terms</Link>
    </div>
  );
}
