...
export default function HomePage() {
  return (
    <>
      {/* Complete SEO Best Practices Metadata */}
      <Helmet>
        <title>Muhammad Arslan | Full Stack Software Developer</title>
        <meta
          name="description"
          content="Full Stack Software Developer building modern web applications, mobile apps, and scalable software solutions."
        />
        <meta name="robots" content="index, follow" />
        <meta property="og:title" content="Muhammad Arslan | Full Stack Software Developer" />
        <meta
          property="og:description"
          content="Building modern web applications, mobile apps, and scalable software solutions."
        />
      ...
      <main className="home-page">
        {/* Main Hero Section */}
        <section className="hero-section" aria-labelledby="hero-title-id">
            ...
            <div className="hero-grid">
              ...
              <div className="hero-content">
                <div className="hero-meta-bar">
                  <span className="status-badge" aria-label="Available for remote roles">
                  ...
                  <span className="location-info">
                    ...
                    Lahore, Pakistan · 09:21 PM UTC+5
                  </span>
                </div>
                ...
                <p className="hero-subtitle">
                  Building modern web applications, mobile apps, and scalable software solutions.
                </p>
              ...
              {/* Right Column: Reference Design Image & Stack Card */}
              <div className="hero-image-wrapper">
                ...
                <div className="stack-card">
                  <span className="stack-card-label">STACK</span>
                  <span className="stack-card-value">
                    React · React Native · Electron · Node
                  </span>
                </div>
              </div>
